...
/**
 * Provides the local service interface for Transaction. Methods of this
...
public interface TransactionLocalService
	...
	public Transaction createTransaction(int id);
	...
	public Transaction deleteTransaction(int id) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Transaction getTransaction(int id) throws PortalException;
