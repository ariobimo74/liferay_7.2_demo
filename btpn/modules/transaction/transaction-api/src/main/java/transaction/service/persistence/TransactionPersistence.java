...
public interface TransactionPersistence extends BasePersistence<Transaction> {
	 ...
	 */
	public java.util.List<Transaction> findByid(int id);
	 ...
	 */
	public java.util.List<Transaction> findByid(int id, int start, int end);
	 ...
	 */
	@Deprecated
	public java.util.List<Transaction> findByid(
