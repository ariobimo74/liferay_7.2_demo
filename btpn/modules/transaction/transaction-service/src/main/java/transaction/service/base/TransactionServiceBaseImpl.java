...
/**
 * Provides the base implementation for the transaction remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link transaction.service.impl.TransactionServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see transaction.service.impl.TransactionServiceImpl
 * @generated
 */
public abstract class TransactionServiceBaseImpl
	extends BaseServiceImpl
	implements TransactionService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TransactionService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>transaction.service.TransactionServiceUtil</code>.
	 */
	 ...
	 */
	public transaction.service.TransactionLocalService
		getTransactionLocalService() {
	...
	public void setTransactionLocalService(
		transaction.service.TransactionLocalService transactionLocalService) {
	...
	@BeanReference(type = transaction.service.TransactionLocalService.class)
	protected transaction.service.TransactionLocalService
