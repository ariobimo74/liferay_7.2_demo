...
package transaction.service.base;
...
/**
 * Provides the base implementation for the transaction local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link transaction.service.impl.TransactionLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see transaction.service.impl.TransactionLocalServiceImpl
 * @generated
 */
@ProviderType
public abstract class TransactionLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements TransactionLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TransactionLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>transaction.service.TransactionLocalServiceUtil</code>.
	 */
	...
	public Transaction createTransaction(int id) {
		return transactionPersistence.create(id);
	}
	...
	public Transaction deleteTransaction(int id) throws PortalException {
		return transactionPersistence.remove(id);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Transaction.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return transactionPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(
		...
		return transactionPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public Transaction fetchTransaction(int id) {
		return transactionPersistence.fetchByPrimaryKey(id);
	}
	...
	public Transaction getTransaction(int id) throws PortalException {
		return transactionPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(transactionLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Transaction.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(Transaction.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return transactionLocalService.deleteTransaction(
			(Transaction)persistedModel);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"transaction.model.Transaction", transactionLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TransactionLocalService.class.getName();
	}
