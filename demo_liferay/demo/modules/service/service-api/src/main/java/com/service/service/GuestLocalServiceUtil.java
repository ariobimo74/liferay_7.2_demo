...
/**
 * Provides the local service utility for Guest. This utility wraps
 * <code>com.service.service.impl.GuestLocalServiceImpl</code> and
 ...
 */
@ProviderType
public class GuestLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.service.service.impl.GuestLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static com.service.model.Guest addGuest(
	 ...
	 */
	public static com.service.model.Guest createGuest(int id) {
		return getService().createGuest(id);
	}
	 ...
	 */
	public static com.service.model.Guest deleteGuest(
		com.service.model.Guest guest) {

		return getService().deleteGuest(guest);
	}
	 ...
	 */
	public static com.service.model.Guest deleteGuest(int id)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().deleteGuest(id);
	}
	...
	public static com.service.model.Guest fetchGuest(int id) {
	 ...
	 * @throws PortalException if a guest with the primary key could not be found
	 */
	public static com.service.model.Guest getGuest(int id)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	public static java.util.List<com.service.model.Guest> getGuests(
		int start, int end) {

		return getService().getGuests(start, end);
	}
	...
	public static int getGuestsCount() {
		return getService().getGuestsCount();
	}
	 ...
	 */
	public static com.service.model.Guest updateGuest(
		com.service.model.Guest guest) {
	...
	private static ServiceTracker<GuestLocalService, GuestLocalService>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(GuestLocalService.class);

		ServiceTracker<GuestLocalService, GuestLocalService> serviceTracker =
			new ServiceTracker<GuestLocalService, GuestLocalService>(
				bundle.getBundleContext(), GuestLocalService.class, null);
