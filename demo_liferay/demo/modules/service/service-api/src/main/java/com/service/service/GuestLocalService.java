...
/**
 * Provides the local service interface for Guest. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see GuestLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface GuestLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link GuestLocalServiceUtil} to access the guest local service. Add custom service methods to <code>com.service.service.impl.GuestLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
